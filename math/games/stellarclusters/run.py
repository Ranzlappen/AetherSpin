"""Entry point for generating Stellar Clusters results in the official math-sdk.

Run from within a cloned math-sdk (see scripts/setup-math.sh):

    cd math/engine && python games/stellarclusters/run.py

For local iteration without the SDK, use the standalone engine instead:

    python math/scripts/generate_books.py --game stellarclusters --sims 1000000
"""
