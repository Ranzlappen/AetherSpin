"""Stellar Clusters simulation state — entry point for a single simulated round.
...
``GameStateOverride`` / executables / calculations mixins (cluster-adapted).
"""
...
class GameState(GameStateOverride):
    ...
    def run_spin(self, sim, simulation_seed=None):
        ...
        while self.repeat:
            ...
            self.evaluate_base_board()  # batched cluster wins + scatter pays
