"""State initialisation and per-round resets for Stellar Clusters.
...
class GameStateOverride(GameExecutables, GeneralGameState):
    def __init__(self, config):
        ...
        # Weighted-expectation wild multiplier used by cluster evaluation in the
        # free game (matches the standalone engine; 1 when multiplier wilds off).
