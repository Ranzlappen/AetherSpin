"""Optimization setup for StellarClusters (real optimization_program API).
            ...
            "base": {
                ...
                "conditions": {
                    ...
                    "freegame": ConstructConditions(
                        rtp=0.66, hr=200, search_conditions={"symbol": "scatter"}
                    ).return_dict(),
                    "basegame": ConstructConditions(rtp=round(target - 0.665, 5), hr=3.5).return_dict(),
                },
