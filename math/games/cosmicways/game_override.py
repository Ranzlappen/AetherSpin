"""State initialisation and per-round resets for Cosmic Ways.
...
class GameStateOverride(GameExecutables, GeneralGameState):
    def __init__(self, config):
        ...
        # Weighted-expectation wild multiplier used by ways evaluation in the free
        # game (matches the standalone engine; 1 when multiplier wilds are off).
