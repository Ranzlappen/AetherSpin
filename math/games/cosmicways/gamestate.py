"""Cosmic Ways simulation state for the official math-sdk (real API).
...
game has no free-game trigger table). Cosmic Ways disables expanding/multiplier
wilds and uses a flat ladder, so the free game is ways + scatter, win-scaled.
"""
